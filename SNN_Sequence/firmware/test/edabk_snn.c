...
void load_packet_in(const char* input_path, const char* num_inputs_path){
	FIL fptr_input[1];
	FRESULT op1 = f_open(fptr_input, input_path, FA_READ);

	FIL fptr_num_inputs[1];
	FRESULT op2 = f_open(fptr_num_inputs, num_inputs_path, FA_READ);
...
void test_function(void){
	...
	load_packet_in("packet_input_4.mem","num_inputs_4.mem");
	while (1)
	{
